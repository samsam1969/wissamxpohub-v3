...
<div class="card" style="margin-bottom:18px;">
  ...
  <div style="display:flex;gap:10px;margin-top:14px;flex-wrap:wrap;">
    <button class="primary" id="searchBtn" onclick="runSearch()" style="flex:1;min-width:160px;">Search Buyers</button>
...
<div class="card">
  ...
  <div style="overflow-x:auto;">
    <table class="buyers-table">
      <thead><tr><th>#</th><th>Company Name</th><th>Country</th><th>Source</th><th>Source Link</th><th>Website</th><th>Email</th><th>Phone</th></tr></thead>
  ...
  <div style="margin-top:14px;font-size:12px;color:var(--muted);line-height:1.9;">Only rows with a real company name AND verified source are displayed. Sources: Europages, Kompass, WLW, Trade Map, LinkedIn.</div>
</div>
</div>
<script>
...
function renderTable(buyers){
  ...
  tbody.innerHTML=buyers.map((b,i)=>{
    const sl=b.sourceLink?'<a href="https://'+b.sourceLink+'" target="_blank" class="ext-link">'+b.sourceLink.split("/")[0]+'</a>':'<span class="tag-none">-</span>';
    const web=b.website?'<a href="https://'+b.website+'" target="_blank" class="ext-link">'+b.website.split("/")[0]+'</a>':'<span class="tag-none">-</span>';
